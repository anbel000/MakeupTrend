...
INSERT INTO `products` (`id`, `name`, `quantity`, `sale_price`, `categorie_id`, `media_id`, `date`, `description`, `brand_id`) VALUES
(1, 'Filtro de gasolina', '100', 10.00, 1, 1, '2017-06-16 07:03:16','Producto de comercialización, pureba número 1', 1);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `FK_brands` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
