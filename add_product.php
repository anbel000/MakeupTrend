...
if (isset($_POST['add_product'])) {
  $req_fields = array('product-title', 'product-categorie', 'product-quantity', 'saleing-price', 'description', 'product-brand');
  ...
  if (empty($errors)) {
    ...
    $query .= " name,quantity,sale_price,categorie_id,media_id,date,description,brand_id,offer";
    $query .= ") VALUES (";
    $query .= " '{$p_name}', '{$p_qty}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}', '{$p_description}', '{$p_brand}', '{$p_sale_offer}'";
    $query .= ")";
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="saleing-price-offer" placeholder="Precio descuento">
                  </div>
                </div>
              </div>
            </div>
