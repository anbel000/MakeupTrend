...
if (isset($_POST['product'])) {
  $req_fields = array('product-title', 'product-categorie', 'product-quantity', 'saleing-price', 'description', 'brand');
              ...
              <div class="col-md-4">
                <select class="form-control" name="brand">
                  ...
                  <?php foreach ($all_brands as $cat) : ?>
                    <option value="<?php echo (int)$cat['id']; ?>" <?php if ($product['brand_id'] === $cat['id']) : echo "selected";
                                                                    endif; ?>>
                      <?php echo remove_junk($cat['name']); ?></option>
                  <?php endforeach; ?>
                </select>
